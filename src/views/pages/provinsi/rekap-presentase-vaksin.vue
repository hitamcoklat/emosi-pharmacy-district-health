<template>
    <div>
        ...
        <v-content class="pl-0">
          <v-container>
              <p style="font-weight: bold; font-size: 1.3em;" class="mt-n12 mx-auto">Rekap Indikator Persentase Instalasi Farmasi Kab/Kota Yang Mengelola Obat & Vaksin Sesuai Standar</p>
              ...
              <div style="padding: 0 !important; margin: 0 !important;" class="my-2">
                <v-col class="d-flex" cols="6" sm="6" style="padding: 0 !important; margin: 0 !important;">
                  <v-select
                    dense
