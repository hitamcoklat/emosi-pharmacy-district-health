  ...
  methods: {
    exportExcell: function () {
      window.location.href =
        ...
        "/read-tenaga?jenis=" +
        this.pilihJenis +
        "&sub_menu=tenaga_teknis&kode_daerah=" +
        this.idDaerah +
        "&export_excell=true";
    },
    ...
    insertFromTemplate: function () {
      ...
      this.$http
        .post(
          this.$apiUrl + "/input-tenaga-template?table_name=tenaga_teknis",
          data
        )
        .then((response) => {
          if (response.data.status == true) {
    ...
    insertData: function () {
      ...
      let url =
        this.isUpdate == false
          ? this.$apiUrl + "/input-tkk?jenis=" + this.pilihJenis
          : this.$apiUrl +
            "/update-tenaga?jenis=" +
            this.pilihJenis +
            "&id=" +
