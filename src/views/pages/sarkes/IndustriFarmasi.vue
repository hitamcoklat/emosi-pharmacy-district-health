<template>
    <div>
        ...
        <v-content class="pl-0">
          <v-container>
              <p style="font-weight: bold; font-size: 1.3em;" class="mt-n12 mx-auto">Data Industri Farmasi</p>
  ...
  name: 'Oblik',
    ...
    methods: {
      ...
      updateData: function() {
        ...
        let url = (this.isUpdate == false) ? this.$apiUrl + '/sarkes/insert?jenis=' + this.pilihJenis : this.$apiUrl + '/sarkes/update?jenis=' + this.pilihJenis + '&id=' + this.id
