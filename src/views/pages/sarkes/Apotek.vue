<template>
    <div>
        ...
        <v-content class="pl-0">
          <v-container>
              <p style="font-weight: bold; font-size: 1.3em;" class="mt-n12 mx-auto">Data Apotek</p>
  ...
  name: 'Oblik',
    ...
    methods: {
      ...
      downloadTemplate: function() {
        window.open('http://maubikin.web.id/e-mosi/public-assets/upload/template_upload_apotek(kabkota).xlsx', '_blank')
      },
      ...
      fetchData: function () {
        ...
        this.dialogLoading = true
        this.$http.get(this.$apiUrl + '/sarkes/getAllData?jenis=apotek&thn=' + this.pilihTahun + '&bln='+indexBulan+'&id_daerah=' + this.idDaerah)
