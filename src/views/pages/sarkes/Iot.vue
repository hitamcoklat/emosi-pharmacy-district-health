    ...
    <div>
        ...
        <v-content class="pl-0">
          <v-container>
              ...
              <v-alert v-show="showWarning" type="warning">
                Bulan dan Tahun belum dipilih.
              </v-alert> 
              <div class="my-2">
                <v-col style="padding-left: 0 !important; padding-right: 0 !important;" class="d-flex" cols="12" sm="12">
                  <v-select
                  ...
                  <v-select
                    ...
                    label="Pilih Tahun"
                  ></v-select>
                  <v-btn style="margin-right: 1em;" v-on:click="fetchData" color="default" x-large>Cek Data</v-btn>
                  <v-btn v-if="showWarning == false" v-on:click="updateData" color="primary" x-large>{{textButton}}</v-btn>
                </v-col> 
                <v-row
                ...
                >
                  <v-col
                    ...
                    md="3"
                  >
                    <v-btn @click="downloadTemplate" v-if="showWarning == false" style="margin-right: 1em;" color="success" x-large>Download Template</v-btn>
                  </v-col>
                  <v-col
                  style="margin-left: 1em;"
                    ...
                    md="3"
                  >
                    <v-file-input v-if="showWarning == false" id="templateExcell" @change="uploadTemplate()"  outlined="" label="Upload Template"></v-file-input>
                  </v-col>
                </v-row>                               
              </div>
              <div>
    ...
    methods: {
      ...
      downloadTemplate: function() {
        console.log(this.pilihJenis)
          window.location.href='http://app.diskes.jabarprov.go.id/e-mosi/upload/template_upload_tokoalkes(kabkota).xlsx'
      },
