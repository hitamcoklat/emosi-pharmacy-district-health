          ...
          <v-btn
            ...
            @click="
              $router.push({
                ...
                params: {
                  title: 'Import Data Sertifikat Produksi Alkes Pusat',
                  tableName: 'master_ser_prod_alkes_pusat',
                },
              })
            "
            depressed
...
import ViewExcell from "@/components/excell/SertifikatProdAlkes";
...
export default {
  ...
  methods: {
    ...
    updateTutup: function (item, i) {
      ...
      this.$http
        .post(
          this.$apiUrl + "/sarkes/update-tutup?t_name=verif_ser_prod_alkes",
          { content: dataKirim }
        )
        .then((response) => {
    ...
    inputVerif: function () {
      ...
      this.$http
        .post(
          this.$apiUrl + "/sarkes/input-verifikasi?t_name=verif_ser_prod_alkes",
          { content: data }
        )
        .then((response) => {
          if (response.data.status == true) {
    ...
    lihatDataVerifikasi: function () {
      ...
      this.$http
        .get(
          this.$apiUrl + "/sarkes/read-verifikasi?t_name=verif_ser_prod_alkes"
        )
        .then((response) => {
    ...
    submitCapa: function () {
      ...
      this.$http
        .post(
          this.$apiUrl + "/sarkes/update-capa?t_name=verif_ser_prod_alkes",
          {
            content: dataKirim,
          }
        )
    ...
    removeData: function () {
      ...
      this.$http
        .post(
          this.$apiUrl +
            "/sarkes/remove-master?t_name=master_ser_prod_alkes_pusat",
          { content: data }
        )
        .then((response) => {
          if (response.data.status == true) {
    ...
    removeItem: function (item) {
      let tblName = "master_ser_prod_alkes_pusat";
    ...
    updateStandar: function (item, i) {
      ...
      this.$http
        .post(
          this.$apiUrl + "/sarkes/update-standar?t_name=verif_ser_prod_alkes",
          { content: dataKirim }
        )
        .then((response) => {
          if (response.data.status == true) {
    ...
    dataCabang: async function () {
      ...
      const res = await fetch(
        `${this.$apiUrl}/sarkes/read-template-pusat?tbl=master_ser_prod_alkes_pusat`
      );
