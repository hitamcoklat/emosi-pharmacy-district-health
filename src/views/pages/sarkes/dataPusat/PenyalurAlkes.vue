          ...
          <v-btn
            ...
            @click="
              $router.push({
                ...
                params: {
                  title: 'Import Data Penyalur Alkes Pusat',
                  tableName: 'master_pak_pusat',
                },
              })
            "
            depressed
...
export default {
  data() {
    return {
      ...
      headersPusat: [
        ...
        { text: "Telp. Kantor", value: "telp", width: "200px" },
        { text: "No. Sertifikat", value: "nomorSertifikat", width: "200px" },
        { text: "NPWP", value: "npwp", width: "200px" },
        { text: "Jenis Produksi", value: "jenisProduk", width: "300px" },
  ...
  methods: {
    ...
    updateTutup: function (item, i) {
      ...
      this.$http
        .post(this.$apiUrl + "/sarkes/update-tutup?t_name=verif_pak_pusat", {
          content: dataKirim,
        })
        .then((response) => {
    ...
    removeData: function () {
      ...
      this.$http
        .post(this.$apiUrl + "/sarkes/remove-master?t_name=master_pak_pusat", {
          content: data,
        })
        .then((response) => {
          if (response.data.status == true) {
    ...
    inputVerif: function () {
      ...
      this.$http
        .post(
          this.$apiUrl + "/sarkes/input-verifikasi?t_name=verif_pak_pusat",
          { content: data }
        )
        .then((response) => {
          if (response.data.status == true) {
    ...
    lihatDataVerifikasi: function () {
      ...
      this.itemPusat = [];
      this.$http
        .get(this.$apiUrl + "/sarkes/read-verifikasi?t_name=verif_pak_pusat")
        .then((response) => {
    ...
    submitCapa: function () {
      ...
      this.$http
        .post(this.$apiUrl + "/sarkes/update-capa?t_name=verif_pak_pusat", {
          content: dataKirim,
        })
        .then((response) => {
          if (response.data.status == true) {
    ...
    removeItem: function (item) {
      // get table name
      let tblName = "master_pak_pusat";
      if (this.$store.getters.statusData == "verifikasi") {
        tblName = "verif_pak_pusat";
      }
    ...
    updateStandar: function (item, i) {
      ...
      this.$http
        .post(this.$apiUrl + "/sarkes/update-standar?t_name=verif_pak_pusat", {
          content: dataKirim,
        })
        .then((response) => {
          if (response.data.status == true) {
    ...
    dataCabang: async function () {
      ...
      const res = await fetch(
        `${this.$apiUrl}/sarkes/read-template-pusat?tbl=master_pak_pusat`
      );
