        ...
        <v-col>
          ...
          <v-card v-if="tampilanExcellCabang">
            ...
            >
              ...
              <vue-excel-column field="bentuk_sediaan" label="Bentuk Sediaan" />
...
export default {
  ...
  methods: {
    ...
    inputVerif: function () {
      ...
      this.$http
        .post(this.$apiUrl + "/sarkes/input-verifikasi?t_name=verifpak", {
          content: data,
        })
        .then((response) => {
    ...
    lihatDataVerifikasi: function () {
      ...
      this.statusData = "verifikasi";
      this.itemCabang = [];
      this.$http
        .get(this.$apiUrl + "/sarkes/read-verifikasi?t_name=verifpak")
        .then((response) => {
    ...
    updateTutup: function (item, i) {
      ...
      this.$http
        .post(this.$apiUrl + "/sarkes/update-tutup?t_name=verifpak", {
          content: dataKirim,
        })
        .then((response) => {
          if (response.data.status == true) {
    ...
    updateStandar: function (item, i) {
      ...
      this.$http
        .post(this.$apiUrl + "/sarkes/update-standar?t_name=verifpak", {
          content: dataKirim,
        })
        .then((response) => {
          if (response.data.status == true) {
