...
export default {
  ...
  methods: {
    ...
    inputVerif: function () {
      ...
      this.$http
        .post(this.$apiUrl + "/sarkes/input-verifikasi?t_name=verifpbf", {
          content: data,
        })
        .then((response) => {
    ...
    lihatDataVerifikasi: function () {
      ...
      this.itemCabang = [];
      this.$http
        .get(this.$apiUrl + "/sarkes/read-verifikasi?t_name=verifpbf")
        .then((response) => {
    ...
    submitCapa: function () {
      ...
      this.$http
        .post(this.$apiUrl + "/sarkes/update-capa?t_name=verifpak", {
          content: dataKirim,
        })
        .then((response) => {
          if (response.data.status == true) {
    ...
    submitCapa: function () {
      ...
      this.$http
        .post(this.$apiUrl + "/sarkes/update-capa?t_name=verifpbf", {
          content: dataKirim,
        })
        .then((response) => {
          if (response.data.status == true) {
    ...
    updateTutup: function (item, i) {
      ...
      this.$http
        .post(this.$apiUrl + "/sarkes/update-tutup?t_name=verifpbf", {
          content: dataKirim,
        })
        .then((response) => {
          if (response.data.status == true) {
    ...
    updateStandar: function (item, i) {
      ...
      this.$http
        .post(this.$apiUrl + "/sarkes/update-standar?t_name=verifpbf", {
          content: dataKirim,
        })
        .then((response) => {
          if (response.data.status == true) {
    ...
    dataCabang: function () {
      ...
      this.$http
        ...
        // this.$http.get(this.$apiUrl + '/sarkes/getCurl?url=http://103.147.222.234/e-mosi/data-json/pbf.json')
        .then((response) => {
