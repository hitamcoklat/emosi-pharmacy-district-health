    ...
    <div>
        ...
        <v-content class="pl-0">
          <v-container>
            ...
            <iframe style="width: 100%; height: 700px; border: 0 !important;" src="https://docs.google.com/forms/d/e/1FAIpQLSfTnclZ3G7Nb0MUsnkSOaAxv8KVNdyNY5qZx5E9GqKJXM_hhQ/viewform" />
          </v-container>
        </v-content>
    </div>
</template>
