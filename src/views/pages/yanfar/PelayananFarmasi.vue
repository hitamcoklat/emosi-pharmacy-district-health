          ...
          <v-container>
            <div style="margin: 20px;">
                ...
                <v-col style="margin: 0 !important; padding: 0 !important;" class="d-flex" cols="12" sm="12">
                  ...
                  <v-btn v-if="dataExist" style="margin-right: 1em;" v-on:click="fetchData" color="primary" x-large>Update Data</v-btn>
                  <v-btn v-if="dataExist" style="margin-right: 1em;" v-on:click="fetchData" color="error" x-large>Hapus Data</v-btn>
                </v-col> 
            </div>            
          </v-container>
        </v-content>
  ...
  name: 'FormPOR',
    data () {
      return {
        ...
        itemFaskes: ['Rumah Sakit', 'Puskesmas'],
        pilihItemFaskes: '',
        itemFilter: ['Laporan Kab/Kota', 'Rekap'],
        pilihItemFilter: '',
        itemFilterRange: ['Per Triwulan', 'Per Bulan'],
        pilihItemFilterRange: '',
        itemFilterPuskesmas: ['Pusk. Perawatan', 'Pusk. Non Perawatan'],
        pilihItemFilterPuskesmas: '',
        isUpdate: false,
        dialogLoading: false,
        showWarning: true,
        idDaerah: '',
